...
import { RouteEvent, RoutingErrorEvent, RoutingStartEvent, RoutesFoundEvent, WaypointGeocodedEvent, GeocodedEvent, LineTouchedEvent, WaypointDragEvent, WaypointsSplicedEvent } from './common/types';
declare type RoutingHandler = {
...
export { RoutingControl, routingControl, Line, line, Plan, plan, Waypoint, waypoint, OSRMv1, osrmv1, Localization, localization, Formatter, formatter, GeocoderElement, geocoderElement, ItineraryBuilder, itineraryBuilder, Mapbox, mapbox, ErrorControl, errorControl, Autocomplete, autocomplete, };
